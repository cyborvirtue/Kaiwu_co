...
def reward_shaping(
    ...
    if prev_treasure_dists and treasure_dists:
        nearest_prev_treasure_dist = min(prev_treasure_dists)
        nearest_treasure_dist = min(treasure_dists)
        if nearest_treasure_dist < nearest_prev_treasure_dist:
            reward_treasure_dist = 1  #修改1 向宝箱靠近的奖励
